...
public class UserBean implements Serializable{
	...
	public String toString() {
		return "UserBean [u_id=" + u_id + ", u_name=" + u_name
				+ ", u_password=" + u_password + ", u_gender=" + u_gender
				+ ", u_age=" + u_age + ", u_phone=" + u_phone + ", u_address="
				+ u_address + ", u_auth=" + u_auth + "]";
	}
	public UserBean() {}
	public UserBean(int u_id, String u_name, String u_password,
			String u_gender, int u_age, String u_phone, String u_address,
			String u_auth) {
		this.u_id = u_id;
		this.u_name = u_name;

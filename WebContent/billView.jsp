...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerView">
            <p><strong>商品名称：</strong><span>${accountBean.a_name}</span></p>
            <p><strong>商品单位：</strong><span>${accountBean.a_unit}</span></p>
            <p><strong>商品数量：</strong><span>${accountBean.a_nums}</span></p>
            <p><strong>总金额：</strong><span>${accountBean.a_amount}</span></p>
            <p><strong>供应商：</strong><span>${accountBean.s_name}</span></p>
            <p><strong>是否付款：</strong><span>${accountBean.a_ispayed}</span></p>
            <p><strong>交易时间：</strong><span>${accountBean.a_Date}</span></p>

...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form action="${pageContext.request.contextPath}/supplierServlet?method=insert" method="post">
                <!--div的class 为error是验证错误，ok是验证成功-->
                <div>
                    <label for="providerName">供应商名称：</label>
                    <input type="text" name="s_name" id="providerName"/>
                </div>
                <div>
                    <label for="people">供应商描述：</label>
                    <input type="text" name="s_info" id="people"/>

                </div>
                <div>
                    <label for="phone">联系人：</label>
                    <input type="text" name="s_linkman" id="phone"/>
                </div>
                <div>
                    <label for="address">联系电话：</label>
                    <input type="text" name="s_phone" id="address"/>
                    <span></span>
                </div>
                          <div>
                    <label for="fax">联系地址：</label>
                    <input type="text" name="s_address" id="fax"/>
                    <span></span>
                </div>
                 <div>
                    <label for="describe">传真：</label>
                    <input type="text" name="s_faxes" id="describe"/>
                </div>  
